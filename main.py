...
import serial
import time
#creating a serial object called 'ard'. We also specify the Port Name and the BaudRate as parameters.
ard = serial.Serial("COM3", 9600)

#creating another object for our Haar Cascade. Make sure the HaarCascade file remains in the same folder as this python program.

face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') 

#creating an object to that captures video from the webcam. 0 as the parameter means the first web cam connected to my PC.
